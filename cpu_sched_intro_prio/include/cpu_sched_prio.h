 ...
 * 
 * When the Funtion starts, it prints that it started and the process' process ID. After every iteration, it prints it's process ID and that it is still running. 
 * @param id 
 */
